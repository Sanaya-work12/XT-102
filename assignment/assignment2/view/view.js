...
export default class View{
    ...
    initialize(){
        this.model.itemChanged.attach((itemName,calorieAmt,total)=>{this.render(itemName,calorieAmt,total)})
        ...
        this.elements.addBtn.addEventListener('click',()=>{
            if (this.elements.itemName.value !="" && this.elements.calorieAmt.value !=""){
                if (Number.isInteger(parseInt(this.elements.calorieAmt.value))) {
                    this.controller.add(this.elements.itemName.value,this.elements.calorieAmt.value);
