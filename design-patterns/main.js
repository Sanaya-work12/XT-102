...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var presenter = new _cityPresenter2.default(view);
	...
	var Presenter = function () {
	    ...
	    _createClass(Presenter, [{
	        ...
	        value: function initialize() {
	            ...
	            this.view.element.addBtn.addEventListener('click', function () {
	                var newCity = prompt('Enter a new City');
	                if (newCity) {
	                    _this.model.add(newCity);
	                }
	            });
	            this.view.element.removeBtn.addEventListener('click', function () {
	                var index = _this.view.element.cityList.options.selectedIndex;
	                if (index != -1) {
	        ...
	        value: function render(newCityList) {
	            this.view.element.cityList.innerHTML = '';
	            ...
	            try {
	                for (var _iterator = newCityList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    this.view.element.cityList.appendChild(new Option(city, city));
	                }
	            } catch (err) {
	    ...
	    _createClass(Observer, [{
	        ...
	        value: function notify(newCity) {
	            this.observers.forEach(function (cb) {
	                //used to call for async functions or updations
	                cb(newCity);
	            });
	        }
	    }]);
